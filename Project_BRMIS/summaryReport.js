(function () {
  ...
  async function exportPDF() {
    ...
    await addElementImage(document.getElementById('chartMonthly')?.parentElement, 'Monthly Collected vs Distributed');
    await addElementImage(document.getElementById('chartByType')?.parentElement, 'Inventory by Blood Type');
